...
<html lang="es">
    ...
    <body class="hold-transition sidebar-mini" x-data="dtGen">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row" id="frmData" autocomplete="off" acction="Series" method="POST">
                            <input type="hidden"  name="accion" value="registro" class="form-control" id="accion" readonly>
                            <input type="hidden" name="idserie" class="form-control" id="idserie" readonly>
        ...
        <!-- JS Page -->
        <script src="assets/js/serie.js" type="text/javascript"></script>        
